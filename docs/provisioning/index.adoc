...
* link:../schemas/rpi/idp/v2/schema.html[IDP Schema Reference,window=_blank]
* link:../schemas/rpi/provisionmap/v1/schema.html[PMAP Schema Reference,window=_blank]
