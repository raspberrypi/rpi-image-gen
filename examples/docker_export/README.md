...
File arm64-rpi-trixie-slim.tar.gz can be published / distributed. To load and run locally:
...
```
```bash
$ docker run --rm -it localhost/rpi:arm64-trixie-slim
root@8e5740683433:/# echo $SHELL
/bin/bash
```
